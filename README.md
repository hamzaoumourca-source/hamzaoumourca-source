...
- MQL5 Expert Advisors & Risk Management
- Unity Game Development
- 3D Modeling & Printing

## Current Projects

- MQL5 Expert Advisors (Trading Bots)
- Arduino & ESP32 Projects
- Unity Applications

## Featured Experience

- Former Freelance Embedded Systems Developer on Fiverr (4.9/5 client rating)
- Arduino Programmer for the **Tremor Watch** wearable medical device project at Prince Mohammad Bin Fahd University
- Creator of **M-DuinoCore**, a custom microcontroller platform launched on Indiegogo

## External Links & Projects

This GitHub account serves as an archive of personal projects, experiments, and prototypes.

- [Fiverr Profile](https://www.fiverr.com/hamuzao/prototype-your-arduino-bluetooth-project)
- [LinkedIn](https://www.linkedin.com/in/hamza-oumour-511b16173)
